...
class cut_model2:
    ...
    def execute1(self, params1, reductor_params1):
    ...
    def execute2(self, params1, params2, reductor_params1, reductor_params2):
    ...
    def execute_full(self, params1, params2, params3, reductor_params1, reductor_params2):
        ...
        state, (C1, C2), (e1, e2) = self.execute2(params1, params2, reductor_params1, reductor_params2)
    ...
    def cost_reductor1(self, reductor_params1):
        self.reductor_params1 = reductor_params1
        state, C, e = self.execute1(self.params1, reductor_params1)
    ...
    def cost_reductor2(self, reductor_params2):
        state, C, e = self.execute2(self.params1, self.params2, self.reductor_params1, reductor_params2)
    ...
    def callback_cost_reductor_initialize1(self, reductor_params1):
        ...
        self.reductor_params1 = reductor_params1
        H, C, e = self.execute1(self.params1, reductor_params1)
    ...
    def callback_cost_reductor_initialize2(self, reductor_params2):
        ...
        self.reductor_params2 = reductor_params2
        H, C, e = self.execute2(self.params1, self.params2, self.reductor_params1, reductor_params2)
        cost = C[1] + np.log(e)
        try: 
            self.initialize_hist2.append([C[1], cost])
        except:
...
class cut_tfim(cut_model2):
    ...
    def initialization(self):
        c = Circuit(self._qubits)
        for q in range(self._qubits):
            c.add(gates.RY(q, theta = .5 * self.t1 * np.pi))
            c.add(gates.Z(q))

        self.initial_state = c.execute().numpy()

    def execute1(self, params1, reductor_params):
        self.params1 = params1

        self.circuit1.set_parameters(params1)
        self.reductor_params = reductor_params

        self.circuit_reductor1.set_parameters(reductor_params)
    ...
    def execute2(self, params1, params2, reductor_params1, reductor_params2):
        ...
        state, C1, e1 = self.execute1(params1, reductor_params1)
        self.circuit_reductor1.set_parameters(reductor_params1 * self.t2)
    ...
    def initialize_reductor1(self, target_params, max_steps, method='l-bfgs-b', options={'maxiter':100}):
        ...
        for i in range(1, max_steps):
            ...
            self.t1 = i / max_steps
            self.initialization()
            C_, e = self.execute1(self.t1*target_params, self.reductor_params1 + grad / max_steps)[1:]
            print(i, C_)
            if C_ >= self._max_entries:
                print("step", i, ":", C_, 'i_', i_)
                self.t1 = (i - 1) / max_steps
                ...
                if success: 
                    sigma = 0.1
                    self.params1 = target_params * self.t1
    ...
    def initialize_reductor2(self, target_params, max_steps, method='l-bfgs-b', options={'maxiter':100}):
        ...
        success = True
        target_params1 = self.params1.copy()
        target_reductor1 = self.reductor_params1.copy()
        self.t1 = 1
        self.initialization()
        for i in range(1, max_steps):
            self.t2 = i / max_steps
            if not success: 
                break
            C_, e = self.execute2(target_params1, target_params * self.t2, target_reductor1, self.reductor_params2 + grad / max_steps)[1:]
            C_ = C_[1]
            print(i, C_)
            if C_ >= self._max_entries:
                print("step", i, ":", C_, 'i_', i_)
                if i - 1 == i_ + 1: 
                    ...
                    i_ = i - 1
                    self.t2 = (i - 1)/max_steps
                
                if success: 
                    print(target_params1, target_reductor1)
                    sigma = 0.1
                    self.params2 = target_params * self.t2
