...
parser.add_argument("--epsilon", type=int, help="Probability of getting a non-considered coefficient in the cut", default=15)
...
def main(qubits, random_layers, cb_layers, epsilon, seed):
    ...
    folder = '/marisdata/perezsalinas/depth-limit2/results_soft_init_fixM/initialize_tfim'
